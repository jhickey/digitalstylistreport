...
<?php endif; // end primary sidebar widgets  ?>
	...
	<h3>About</h3>
<p class="about">ThemeMeme Aperio was designed by <a href="http://www.themememe.com/" title="ThemeMeme">ThemeMeme</a>. You will always find the latest information for this theme at <a href="http://www.themememe.com/wordpress-theme-themememe-aperio" title="WordPress Theme: ThemeMeme Aperio">WordPress Theme: ThemeMeme Aperio</a>. You can delete this text by editing <strong>sidebar.php</strong> in the <strong>themememe_aperio</strong> theme folder.</p>
